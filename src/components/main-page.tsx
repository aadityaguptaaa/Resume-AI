    ...
    <div className="flex min-h-screen w-full flex-col">
        ...
        <div className="mx-auto grid max-w-6xl gap-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-lg text-muted-foreground">
              Get instant feedback, ATS analysis, and even a roast of your resume to land your dream job.
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Paste your resume content below or upload a .txt or .pdf file to get started.
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <footer className="mt-auto border-t py-4">
        <div className="container mx-auto text-center text-sm text-muted-foreground">
          <p>Built with ResumeAI | Your AI Co-pilot for Career Success</p>
        </div>
      </footer>
    </div>
  );
