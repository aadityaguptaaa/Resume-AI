...
export function AtsReadabilityTab({ resumeText }: AtsReadabilityTabProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>ATS Readability Score</CardTitle>
        <CardDescription>
          See how easily an Applicant Tracking System (ATS) can parse your resume. The AI will provide a score and suggestions to improve formatting for automated systems.
        </CardDescription>
      </CardHeader>
